public class EmployeeService
{
    ...
    public async Task<List<Attendance>> GetAttendanceAsync(int id)
    {
        var attendance = await _httpClient.GetFromJsonAsync<List<Attendance>>($"http://localhost:5148/api/employees/{id}/attendance");
